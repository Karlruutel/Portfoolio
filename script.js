var string = "Welcome to my portfolio! My name is Karl Rüütel.";
var str = string.split("");
var tt = document.getElementById('typedtext');

var string2 = "I'm a junior developer who is interested about the power of programming to transform our world. From simple websites to complex applications, software has the ability to solve real-world problems and create value for its users in ways that were previously unimaginable.";
